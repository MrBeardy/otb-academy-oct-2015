...
RSpec.describe "methods in ruby" do
  ...
  it "is not possible to call methods with the wrong number of arguments" do
    expect { a_global_method }.to raise_error( ArgumentError, /0 for 2/ ) # HINT: Fill in the error and part of the message

    expect { a_global_method(1,2,3) }.to raise_error( ArgumentError, /3 for 2/ ) # HINT: Fill in the error and part of the message
  end
